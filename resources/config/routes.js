...
const { acceptUser, rejectUser, disableUser, enableUser } = require("../controllers/admin_methods");
...
const routes = {
    ...
    "PUT": {
        ...
        "/enable_user": new Routing(enableUser, force_admin),
    },
    "DELETE": {
        ...
        "/disable_user": new Routing(disableUser, force_admin),
    },
};
